...
export default async function AccountPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
      <section className="relative overflow-hidden rounded-[1.8rem] bg-domify-primary-dark p-6 text-white shadow-[0_28px_70px_-42px_rgba(16,47,66,0.8)] sm:p-9 lg:p-11">
