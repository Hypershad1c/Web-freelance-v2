...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_78%_12%,rgba(232,203,145,0.16),transparent_24rem)] bg-domify-primary-dark text-white">
        ...
        <div className="mx-auto grid min-h-[680px] max-w-7xl items-center gap-12 px-4 py-14 sm:px-6 lg:min-h-[730px] lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:py-20">
          ...
          <MotionDiv initial={{ opacity: 0, scale: 0.97, x: 18 }} animate={{ opacity: 1, scale: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.12, ease: [0.23, 1, 0.32, 1] }} className="relative min-h-[470px] lg:min-h-[610px]">
        ...
        <MotionDiv className="relative z-20 mx-auto -mb-14 max-w-7xl px-4 sm:px-6 lg:px-8" initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3, ease: [0.23, 1, 0.32, 1] }}>
      ...
      <section className="border-b border-domify-dark/7 bg-[linear-gradient(180deg,#f5f1e8_0%,#fbfaf7_100%)] pt-24">
      ...
      <section className="relative overflow-hidden bg-[radial-gradient(circle_at_10%_20%,rgba(232,203,145,0.12),transparent_22rem)] bg-[#fcfbf8] py-24 sm:py-32">
