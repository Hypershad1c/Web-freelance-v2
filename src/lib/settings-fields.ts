...
export const SETTINGS_FIELDS = [
  ...
  { key: "contact_phone", label: "Téléphone de contact", defaultValue: "" },
  { key: "contact_email", label: "Email de contact", defaultValue: "" },
  { key: "contact_address", label: "Adresse", defaultValue: "" },
  { key: "whatsapp_number", label: "Numéro WhatsApp par défaut", defaultValue: "" },
