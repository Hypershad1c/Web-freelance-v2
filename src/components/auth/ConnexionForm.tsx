...
export default function ConnexionForm() {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-16 sm:px-6">
      ...
      <div className="mt-8">
        <GoogleSignInButton callbackUrl={explicitCallbackUrl || undefined} />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="text-right">
          <Link href="/mot-de-passe-oublie" className="text-xs font-medium text-domify-dark/50 hover:text-domify-primary">
            Mot de passe oublié ?
          </Link>
        </div>
